<!DOCTYPE html>
<html id="todo">
  <link rel="stylesheet" href="/Mudsic/Assets/Reproductor/estilos.css">
  <body>
  <audio id="actual">
  ...
  <div class="container" align = "center">
    ...
    <p id="nombreCancion" ></p>
      ...
      <button class="nav" onclick= "reproducir()">
        <img src="/Mudsic/Assets/Reproductor/iconos/play.png" width="40" height="40" id="PP" >
      </button>

      <button id="parar" class="nav" onclick= "parar()">
        <img src="/Mudsic/Assets/Reproductor/iconos/stop.png" width="40" height="40" >
      </button>
      ...
      <button id="reaccion" class="nav" onclick="reaccionar()">
          <img src="Assets/reproductor/iconos/like_icon.png" width="40" height="40" >
      </button>

      <button id="repetir" class="nav" onclick= "repetir()">
        <img src="/Mudsic/Assets/Reproductor/iconos/replay.png" width="40" height="40" />
      </button>

      <button id="Vol"  onclick="abrirVolumen()">
        <input  type="range" min="0" max="100" step="1" value="100" id="volumen"/>
        <img src="/Mudsic/Assets/Reproductor/iconos/volume_medium.png" width="40" height="40" >
      </button> 
    </div>
    <script src="assets/audioPlayer/player.js"></script>
  </body>
</html>
